...
public class InsertAuthor extends JPanel{
    ...
    public InsertAuthor(JFrame frm,Database db) throws ClassNotFoundException{
	...
	eh = new ExceptionHandler();
        ...
        closeButton.addActionListener((ActionEvent ae) -> {
            try {
                InsertAuthor.frame = new Frame(frm, Page.Show, db);
        ...
        insertButton.addActionListener((ActionEvent ae) -> {
            try {
                db.insertAuthor(firstNameField.getText(),lastNameField.getText());
